...
function accordionLink() { //allows accordions to be opened via a link on the page.
  var accordionLinks = document.querySelectorAll("a.accordion__open-link"); //accordion open links must have this specific class. Get all elements with this class
